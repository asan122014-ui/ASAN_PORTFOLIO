              ...
              {submitted ? (
                ...
                >
                  ...
                  <div className="grid gap-5 sm:grid-cols-2">
                    ...
                    <button
                      type="submit"
                      className="group mt-2 flex w-full items-center justify-center gap-2 rounded-full bg-[#FFC65C] px-6 py-4 text-[13px] font-extrabold text-[#000000] transition-all hover:-translate-y-0.5 hover:bg-[#C96A00] hover:text-white sm:col-span-2"
                    >
                      Submit Driver Enquiry
